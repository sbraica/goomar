          ...
          Padding(
            ...
            child: Center(
              child: Chip(
                ...
                label: Text(
                  authProvider.currentUser?.username ?? 'Operator',
            ...
            _showConfirmDialog(
              ...
              'Are you sure you want to approve this reservation?',
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Reservation for ${reservation.name} approved'),
          ...
          onReject: () {
            _showConfirmDialog(
              ...
              'Are you sure you want to reject this reservation?',
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Reservation for ${reservation.name} rejected'),
