                    ...
                    child: Form(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                          Card(
                              ...
                              child: Padding(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    TextFormField(
                                        controller: _phoneController,
                                        decoration: const InputDecoration(labelText: 'Registracija', prefixIcon: Icon(Icons.text_increase_sharp)),
                                        keyboardType: TextInputType.phone,
                                        validator: (value) {
                                          if (value == null || value.isEmpty) {
                          ...
                          ElevatedButton(
                              ...
                              child: const Text('Submit Reservation', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                          const SizedBox(height: 16),
                        ]))))));
  }
}
